...
class HealthMonitor:
    ...
    def __init__(self, pipeline: Optional[GuardrailPipeline] = None, 
    ...
    def record_event(self, event_type: str, source: str, message: str, 
    ...
    def _determine_overall_status(self, pipeline_status: Dict[str, Any], 
                                api_keys_status: Dict[str, bool],
                                rate_limiter_status: Dict[str, Any],
                                recent_errors: List[HealthEvent]) -> str:
        ...
        recent_error_count = len([e for e in recent_errors 
...
def print_health_status(health: SystemHealth, detailed: bool = False) -> None:
    ...
    if detailed:
        ...
        print(f"Block Rate: {metrics['blocked_requests']/max(metrics['total_requests'], 1)*100:.1f}%")
