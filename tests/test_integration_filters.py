...
class TestPhase5aIntegration:
    ...
    def test_filter_creation_from_config(self, registry):
        ...
        assert isinstance(pii_filter, SimplePIIDetectionFilter)
        ...
        assert isinstance(toxicity_filter, SimpleToxicityDetectionFilter)
        ...
        assert isinstance(code_filter, SimpleCodeGenerationFilter)
    ...
    async def test_filter_interface_compliance(self, registry):
        ...
        toxicity_filter = create_guardrail_from_config(toxicity_config, registry)
        filters.append(toxicity_filter)
        ...
        for filter_instance in filters:
            ...
            assert hasattr(filter_instance, 'analyze')
            assert hasattr(filter_instance, 'is_available')
            assert hasattr(filter_instance, 'get_config')
            assert hasattr(filter_instance, 'update_config')
            assert hasattr(filter_instance, 'get_name')
            assert hasattr(filter_instance, 'get_type')
            assert hasattr(filter_instance, 'is_enabled')
            assert hasattr(filter_instance, 'enable')
            assert hasattr(filter_instance, 'disable')
            ...
            # Test enable/disable
            original_enabled = filter_instance.is_enabled()
            filter_instance.disable()
            assert filter_instance.is_enabled() is False
            filter_instance.enable()
            assert filter_instance.is_enabled() is True
    ...
    async def test_filter_independence(self, registry):
        ...
        toxicity_result = await toxicity_filter.analyze(toxicity_content) if toxicity_filter else None
    ...
    def test_configuration_validation(self, registry):
        ...
        if isinstance(valid_filter, SimplePIIDetectionFilter):
    ...
    async def test_filter_performance(self, registry):
        ...
        filter_instance = create_guardrail_from_config(config, registry)
        
        # Test simple content performance
        simple_content = "This is a normal message without PII."
        start_time = time.time()
        result = await filter_instance.analyze(simple_content) if filter_instance else None
        end_time = time.time()
        ...
        start_time = time.time()
        result = await filter_instance.analyze(complex_content) if filter_instance else None
        end_time = time.time()
