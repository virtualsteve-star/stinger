...
class TestInputContentValidation:
    ...
    def test_valid_content(self):
        ...
        validator.validate_input_content("Test content " * 300, "response")  # 3KB response with variety
...
class TestValidatorStateManagement:
    ...
    def test_usage_statistics(self):
        ...
        assert abs(usage['requests_per_minute'] - 1.0) < 0.01  # 5 requests / 5 minutes (allow floating point precision)
