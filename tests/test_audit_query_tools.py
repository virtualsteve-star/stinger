...
class TestAuditQueryTools:
    ...
    def test_query_by_event_type(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            audit.log_guardrail_decision("test_filter", "allow", "Test reason", 
    ...
    def test_print_query_results(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            audit.log_guardrail_decision("content_filter", "allow", "Content is safe", 
                                         user_id="user_123", conversation_id="conv_456")
            audit.log_response("AI is artificial intelligence.", user_id="user_123", conversation_id="conv_456")
    ...
    def test_pipeline_integration_with_query(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            conversation = stinger.Conversation("test_user", "assistant", conversation_id="test_conv")
