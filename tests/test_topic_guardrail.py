...
class TestTopicFilter:
    ...
    async def test_deny_mode_blocked(self):
        ...
        config = {"name": "deny_test", "mode": "deny", "deny_topics": ["politics", "religion"]}
    ...
    async def test_both_mode_deny_priority(self):
        ...
        result = await guardrail_obj.analyze(
            "I need customer service but also want to discuss politics"
        )
    ...
    async def test_empty_content(self):
        ...
        config = {"name": "empty_test", "mode": "deny", "deny_topics": ["politics"]}
...
class TestTopicFilterEdgeCases:
    ...
    async def test_empty_topic_lists(self):
        ...
        config = {"name": "empty_lists_test", "mode": "both", "allow_topics": [], "deny_topics": []}
    ...
    async def test_very_long_content(self):
        ...
        config = {"name": "long_content_test", "mode": "deny", "deny_topics": ["politics"]}
    ...
    async def test_special_characters(self):
        ...
        config = {"name": "special_chars_test", "mode": "deny", "deny_topics": ["politics"]}
    ...
    async def test_unicode_content(self):
        ...
        config = {"name": "unicode_test", "mode": "deny", "deny_topics": ["politics"]}
