...
class TestCLIDemoBehavior:
    ...
    def test_demo_blocks_obvious_pii(self):
        ...
        try:
            ...
            assert ("credit card" in output.lower() or "pii" in output.lower() or 
                    "1234-5678-9012-3456" in output), \
    ...
    def test_demo_allows_safe_content(self):
        ...
        for input_text in safe_inputs:
            try:
                ...
                assert "ALLOWED" in output or "BLOCKED" not in output, \
    ...
    def test_check_json_output(self):
        ...
        try:
            ...
            if "BLOCKED" in output:
                assert "Reason" in output or "reason" in output or "-" in output, \
    ...
    def test_web_demo_analyze_endpoint(self):
        ...
        try:
            ...
            response = client.post(
                "/analyze",
                json={"text": "My SSN is 123-45-6789", "preset": "default"}
            )
            ...
            response = client.post(
                "/analyze",
                json={"text": "Hello world", "preset": "default"}
            )
...
class TestDemoConsistency:
    ...
    def test_all_demos_block_pii(self):
        ...
        if available_results:
            assert all(available_results), \
                "All demos should consistently block PII"
