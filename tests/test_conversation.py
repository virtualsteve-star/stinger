...
class TestTurn:
    ...
    def test_turn_creation(self):
        ...
        turn = Turn(
            timestamp=datetime.now(), prompt="Hello, world!", speaker="user_123", listener="gpt-4"
        )
    ...
    def test_turn_timestamp_conversion(self):
        ...
        turn = Turn(timestamp=timestamp_int, prompt="Test", speaker="user_123", listener="gpt-4")
...
class TestConversation:
    ...
    def test_conversation_creation_with_metadata(self):
        ...
        conv = Conversation.human_ai(
            "user_123", "gpt-4", conversation_id="test_123", metadata=metadata
        )
    ...
    def test_conversation_creation_with_rate_limit(self):
        ...
        conv = Conversation.human_ai(
            "user_123", "gpt-4", conversation_id="test_123", rate_limit=rate_limit
        )
    ...
    def test_from_dict_with_metadata(self):
        ...
        original_conv = Conversation.human_ai(
            "user_123", "gpt-4", conversation_id="test_123", metadata=metadata
        )
...
class TestConversationEdgeCases:
    ...
    def test_serialization_with_complex_metadata(self):
        ...
        metadata = {"nested": {"key": "value"}, "list": [1, 2, 3], "boolean": True, "number": 42.5}
        conv = Conversation.human_ai(
            "user_123", "gpt-4", conversation_id="test_123", metadata=metadata
        )
