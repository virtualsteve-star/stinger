...
class TestTopicFilter:
    ...
    def test_filter_creation(self):
        ...
        assert filter_obj.name == 'test_topic_filter'
        assert filter_obj.enabled is True
        assert filter_obj.allow_topics == ['allowed1', 'allowed2']
        assert filter_obj.deny_topics == ['denied1', 'denied2']
        assert filter_obj.mode == 'deny'
    ...
    def test_filter_creation_with_defaults(self):
        ...
        assert filter_obj.allow_topics == []
        assert filter_obj.deny_topics == []
        assert filter_obj.mode == 'deny'
        assert filter_obj.case_sensitive is False
        assert filter_obj.use_regex is False
        assert filter_obj.confidence_threshold == 0.5
    ...
    def test_guardrail_interface_compatibility(self):
        ...
        # Test check method
        result = filter_obj.check("I want to discuss politics")
    ...
    def test_get_config(self):
        ...
        filter_obj = TopicFilter(config)
        retrieved_config = filter_obj.get_config()
    ...
    def test_update_config(self):
        ...
        success = filter_obj.update_config(new_config)
        assert success is True
        
        assert filter_obj.deny_topics == ['new_topic']
        assert filter_obj.mode == 'allow'
        assert filter_obj.allow_topics == ['allowed_topic']
    ...
    def test_get_guardrail_type(self):
        ...
        guardrail_type = filter_obj.get_guardrail_type()
    ...
    def test_is_available(self):
        ...
        assert filter_obj.is_available() is True
    ...
    def test_get_health_status(self):
        ...
        filter_obj = TopicFilter(config)
        health = filter_obj.get_health_status()
