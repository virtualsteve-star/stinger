...
class TestLengthFilter:
    ...
    async def test_only_minimum_length(self):
        ...
        config = {"min_length": 5, "action": "block", "on_error": "allow"}
    ...
    async def test_only_maximum_length(self):
        ...
        config = {"max_length": 50, "action": "block", "on_error": "allow"}
        guardrail_instance = LengthGuardrail(config)
    ...
    async def test_different_actions(self):
        ...
        # Test warn action
        config = {"min_length": 10, "max_length": 20, "action": "warn", "on_error": "allow"}
        guardrail_instance = LengthGuardrail(config)
    ...
    def test_initialization_validation(self):
        ...
        valid_config = {"min_length": 5, "max_length": 50, "action": "block", "on_error": "allow"}
    ...
    async def test_zero_length_limits(self):
        ...
        config = {"min_length": 0, "max_length": 0, "action": "block", "on_error": "allow"}
        guardrail_instance = LengthGuardrail(config)
    ...
    async def test_no_length_limits(self):
        ...
        config = {"action": "block", "on_error": "allow"}
        guardrail_instance = LengthGuardrail(config)
