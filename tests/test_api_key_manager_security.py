...
class TestAPIKeyManagerSecurity:
    ...
    def test_key_export_production_block(self):
        ...
        with patch('src.stinger.core.api_key_manager.ENCRYPTION_AVAILABLE', True), \
             patch('src.stinger.core.api_key_manager.Fernet') as mock_fernet, \
             patch('sys.argv', ['stinger']):  # Non-test argv
