...
class TestRegexFilterSecurity:
    ...
    def test_safe_regex_filter_creation(self):
        ...
        config = {"patterns": [r"hello", r"[a-z]+", r"\d{1,5}"], "blocked": True}
    ...
    async def test_regex_filter_safe_execution(self):
        ...
        config = {"patterns": [r"test", r"hello"], "blocked": True}
    ...
    async def test_regex_filter_timeout_protection(self):
        ...
        config = {"patterns": [r"a+"], "blocked": True}
...
class TestReDoSAttackSimulation:
        ...
        for pattern in dangerous_patterns:
            ...
            if not is_safe:
                ...
                assert any(
                    ...
                    for word in ["dangerous", "complex", "nested", "overlap", "pattern"]
                ), f"Pattern '{pattern}' rejected for unexpected reason: {reason}"
    ...
    def test_real_world_safe_patterns(self):
        ...
        for pattern in real_world_patterns:
            ...
            assert (
                is_safe
            ), f"Real-world pattern '{pattern}' should be safe but was rejected: {reason}"
