...
class TestPIIDetectionBehavior:
    ...
    def test_blocks_obvious_pii(self):
        ...
        config = {"name": "pii_detection", "config": {"confidence_threshold": 0.8}}
    ...
    def test_medium_confidence_pii(self):
        ...
        config = {"name": "pii_medium", "config": {"confidence_threshold": 0.5}}
        guardrail = SimplePIIDetectionGuardrail("test", config)
    ...
    def test_confidence_threshold_controls_behavior(self):
        ...
        strict_config = {"name": "pii_strict", "config": {"confidence_threshold": 0.3}}
        strict = SimplePIIDetectionGuardrail("strict", strict_config)

        # Lenient configuration (high threshold)
        lenient_config = {"name": "pii_lenient", "config": {"confidence_threshold": 0.95}}
    ...
    def test_pattern_selection_works(self):
        ...
        ssn_only_config = {
            "name": "ssn_only",
            "config": {"patterns": ["ssn"], "confidence_threshold": 0.8},
        }
    ...
    def test_action_configuration(self):
        ...
        block_config = {
            "name": "pii_block",
            "config": {"action": "block", "confidence_threshold": 0.8},
        }
        ...
        warn_config = {
            "name": "pii_warn",
            "config": {"action": "warn", "confidence_threshold": 0.8},
        }
        ...
        allow_config = {
            "name": "pii_allow",
            "config": {"action": "allow", "confidence_threshold": 0.8},
        }
    ...
    def test_performance_acceptable(self):
        ...
        # Single analysis
        start = time.time()
        asyncio.run(guardrail.analyze("Check this text for PII content"))
