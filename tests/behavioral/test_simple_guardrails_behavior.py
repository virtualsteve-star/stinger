...
class TestRegexGuardrailBehavior:
    ...
    def test_case_sensitivity(self):
        ...
        for word in test_words:
            ...
            print(f"'{word}' - Sensitive: {sens_result.blocked}, Insensitive: {insens_result.blocked}")
...
class TestCodeGenerationBehavior:
    ...
    def test_obvious_code_requests(self):
        ...
        config = {
            "name": "code_gen",
            "config": {
                "confidence_threshold": 0.3  # Lowered to match actual confidence scores
            }
        }
    ...
    def test_category_specific_blocking(self):
        ...
        config = {
            "name": "code_selective",
            "config": {
                "categories": ["web_development", "database"],
                "confidence_threshold": 0.6
            }
        }
        guardrail = SimpleCodeGenerationGuardrail("test", config)
