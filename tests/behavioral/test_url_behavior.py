...
class TestURLGuardrailBehavior:
    ...
    def test_subdomain_handling(self):
        ...
        config = {
            "name": "url_subdomain",
            "config": {"blocked_domains": ["evil.com"], "action": "block"},
        }
        guardrail = URLGuardrail(config)
    ...
    def test_url_detection_patterns(self):
        ...
        config = {
            "name": "url_patterns",
            "config": {"blocked_domains": ["blocked.com"], "action": "block"},
        }
        guardrail = URLGuardrail(config)
    ...
    def test_action_configuration(self):
        ...
        warn_config = {
            "name": "url_warn",
            "config": {"blocked_domains": ["suspicious.com"], "action": "warn"},
        }
        ...
        allow_config = {
            "name": "url_allow",
            "config": {"blocked_domains": ["tracked.com"], "action": "allow"},
        }
    ...
    def test_empty_configuration(self):
        ...
        config = {
            "name": "url_empty",
            "config": {"blocked_domains": [], "allowed_domains": [], "action": "block"},
        }
        guardrail = URLGuardrail(config)
...
def test_financial_url_scenario():
    ...
    config = {
        "name": "financial_urls",
        "config": {
            "allowed_domains": ["mybank.com", "securepayment.com", "officialbank.org"],
            "blocked_domains": ["phishing-bank.com", "fake-payment.org", "scam.com"],
            "action": "block",
        },
    }
    guardrail = URLGuardrail(config)
