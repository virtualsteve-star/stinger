...
class TestConversationPipelineIntegration:
    ...
    def test_conversation_rate_limiting_in_pipeline(self):
        ...
        conv = Conversation.human_ai("test_user", "gpt-4", conversation_id="rate_test", rate_limit=rate_limit)
    ...
    def test_conversation_metadata_preservation(self):
        ...
        conv = Conversation.human_ai("test_user", "gpt-4", conversation_id="metadata_test", metadata=metadata)
