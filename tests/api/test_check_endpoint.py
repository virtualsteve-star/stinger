...
class TestCheckEndpoint:
    ...
    def test_check_metadata_fields(self, client):
        ...
        request_data = {"text": "Test message", "kind": "prompt", "preset": "customer_service"}
    ...
    def test_check_invalid_preset(self, client):
        ...
        request_data = {"text": "Test message", "kind": "prompt", "preset": "nonexistent_preset"}
    ...
    def test_check_missing_required_fields(self, client):
        ...
        # Missing text
        request_data = {"kind": "prompt"}

        response = client.post("/v1/check", json=request_data)
        assert response.status_code == 422  # Unprocessable Entity

        # Missing kind uses default
        request_data = {"text": "Test message"}
    ...
    def test_check_invalid_kind(self, client):
        ...
        request_data = {"text": "Test message", "kind": "invalid_kind"}
    ...
    def test_check_response_headers(self, client):
        ...
        request_data = {"text": "Test message", "kind": "prompt"}
