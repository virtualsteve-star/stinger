...
class TestAPIIntegration:
    ...
    def test_concurrent_requests(self, client):
        ...
        def make_check_request(text):
            return client.post(
                "/v1/check", json={"text": text, "kind": "prompt", "preset": "customer_service"}
            )
    ...
    def test_different_presets_different_behavior(self, client):
        ...
        response1 = client.post(
            "/v1/check", json={"text": test_text, "kind": "prompt", "preset": "customer_service"}
        )

        # Test with medical preset
        response2 = client.post(
            "/v1/check", json={"text": test_text, "kind": "prompt", "preset": "medical"}
        )
