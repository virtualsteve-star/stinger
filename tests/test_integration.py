...
class ConversationSimulator:
    ...
    async def simulate_conversation(
        self, test_cases: List[dict], show_conversation: bool = True
    ) -> Dict:
    ...
    def _display_message(
        self, turn: int, speaker: str, content: str, action: str, reason: str, expected: str
    ):
...
async def main():
    ...
    parser.add_argument(
        "--test", choices=["customer", "medical", "all"], default="all", help="Which test to run"
    )
    parser.add_argument(
        "--quiet", action="store_true", help="Run without showing conversation details"
    )
    parser.add_argument(
        "--transcript", action="store_true", help="Show transcript view with inline moderation tags"
    )
