...
class TestRegexFilter:
    ...
    async def test_complex_regex_patterns(self):
        ...
        config = {"patterns": complex_patterns, "action": "block", "on_error": "allow"}
        guardrail_instance = RegexGuardrail(config)
    ...
    async def test_no_patterns_configured(self):
        ...
        config = {"patterns": [], "action": "block", "on_error": "allow"}
        guardrail_instance = RegexGuardrail(config)
    ...
    async def test_different_actions(self):
        ...
        # Test warn action
        config = {"patterns": ["test"], "action": "warn", "on_error": "allow"}
        guardrail_instance = RegexGuardrail(config)
    ...
    def test_invalid_regex_patterns(self):
        ...
        for pattern in invalid_patterns:
            config = {"patterns": [pattern], "action": "block", "on_error": "allow"}
    ...
    async def test_unicode_content(self):
        ...
        config = {"patterns": [r"[émöjïs]", r"🚀"], "action": "block", "on_error": "allow"}
        guardrail_instance = RegexGuardrail(config)
    ...
    async def test_word_boundaries(self):
        ...
        config = {"patterns": [r"\btest\b"], "action": "block", "on_error": "allow"}
        guardrail_instance = RegexGuardrail(config)
    ...
    async def test_pattern_order_independence(self):
        ...
        for i in range(3):
            ...
            config = {"patterns": rotated_patterns, "action": "block", "on_error": "allow"}
            guardrail_instance = RegexGuardrail(config)
